...
game_images = {} 
framepersecond = 32
pipeimage = str(current_path)+'/images/pipe.png'
background_image = str(current_path)+'/images/background.jpg'
birdplayer_image = str(current_path)+'/images/bird.png'
sealevel_image = str(current_path)+'/images/base.jfif'
...
if __name__ == "__main__": 
	...
	game_images['scoreimages'] = ( 
		pygame.image.load(str(current_path)+'/images/0.png').convert_alpha(), 
		pygame.image.load(str(current_path)+'/images/1.png').convert_alpha(), 
		pygame.image.load(str(current_path)+'/images/2.png').convert_alpha(), 
		pygame.image.load(str(current_path)+'/images/3.png').convert_alpha(), 
		pygame.image.load(str(current_path)+'/images/4.png').convert_alpha(), 
		pygame.image.load(str(current_path)+'/images/5.png').convert_alpha(), 
		pygame.image.load(str(current_path)+'/images/6.png').convert_alpha(), 
		pygame.image.load(str(current_path)+'/images/7.png').convert_alpha(), 
		pygame.image.load(str(current_path)+'/images/8.png').convert_alpha(), 
		pygame.image.load(str(current_path)+'/images/9.png').convert_alpha() 
	) 
